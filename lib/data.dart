List<Map<String, dynamic>> questionsData = [
  ...
  },
  {
    "category": "CSS",
    "category_image":
        "https://brandslogos.com/wp-content/uploads/images/large/css-logo.png",
    "questions": [
      {
      ...
      {
        "title": "How do you select an element with id 'demo' in CSS?",
        "id": 3,
    ...
    "questions": [
      {
        ...
        "id": 1,
        "answers": ["Netscape", "Microsoft", "Google", "Mozilla"],
        "correct_answer": 0,
      },
      {
        "title":
      ...
      },
      {
        ...
        "id": 4,
        "answers": ["onclick", "onchange", "onmouseover", "onmouseout"],
        "correct_answer": 0,
      },
      {
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "title": "Which data structure uses LIFO (Last In, First Out)?",
        "id": 4,
        "answers": ["Stack", "Queue", "Array", "Linked List"],
        "correct_answer": 0,
      },
      {
        "title": "What is the purpose of a loop in programming?",
        "id": 5,
        "answers": [
